...
- Become a detective and solve some puzzles using Kusto Query Langugage at [Kusto Detective Agency](https://detective.kusto.io), or complete the cyber [SANS2023 Holiday Challange](https://detective.kusto.io/sans2023). You can reuse the same Fabric KQL DB that you have used to complete Fabric RTA in A Day challenges.
  ![KDA Season 2 Badge](/assets/images/KDAseason2Badge.png "Principal Detective Agent")  ![SANS2023 Badge](/assets/images/SANS2023badge.png "SANS 2023 Badge")
